  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4 bg-black">
      <div className="w-full max-w-sm bg-[#111] border border-zinc-800 p-8 rounded-2xl shadow-2xl relative overflow-hidden">
        ...
        {/* Top glow */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-1 bg-blue-500/50 blur-lg" />
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <input
            ...
            className="w-full bg-black border border-zinc-800 rounded-lg py-3 px-4
                       ...
                       text-center text-lg tracking-[0.5em] text-white"
          />
        ...
        <div className="mt-8 text-center">
          <button
            onClick={() => {
              if (
                window.confirm(
                  'CRITICAL WARNING:\n\nThis will permanently delete ALL diary entries.\nThis action cannot be undone.\n\nProceed?'
                )
              ) {
                onReset();
              }
            ...
            className="text-xs text-zinc-600 hover:text-red-400
                       transition-colors uppercase tracking-widest font-bold"
          >
            Wipe Vault & Reset
          </button>
        </div>
